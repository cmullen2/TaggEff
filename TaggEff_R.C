...
//Char_t outfilename[100] ="TaggEff_Sep-2015_R";
Char_t outfilename[100] ="TaggEff_Aug-2016_R"; 	//Chris Edit 08/16 
...
void taggeff_ana(Int_t setno, Int_t useEg)
{
  ...
  for(Int_t i=0;i<files;i++)
	...
	noBG=1;
      ...
      fscalers = (TH1F*)file->Get("BadScR_SumFPDScalers");		//Take out or go back and run acquroot like roddy, his setup files etc.
